...
<div class="container">
    <header>
        ...
        <p class="subtitle">ESP32 Real-Time Sensor Data</p>
    ...
    <section id="admin-section" class="admin-panel">
        ...
        <div id="admin-tab-users" class="admin-tab-content active">
            <div class="admin-content">
                            ...
                            <tr>
                                ...
                                <?php if ($user['user_id'] != getCurrentUserId()): ?>
                                    ...
                                    <form method="POST" style="display:inline;" onsubmit="return confirm('Delete this user?');">
                                        <input type="hidden" name="csrf_token" value="<?= $csrfToken ?>"><input type="hidden" name="user_id" value="<?= $user['user_id'] ?>"><input type="hidden" name="admin_action" value="delete_user">
                ...
                <h3>Clear History Data</h3>
                <form method="POST" class="clear-history-form" onsubmit="return confirm('Clear old history?');">
                    <input type="hidden" name="csrf_token" value="<?= $csrfToken ?>">
                    <input type="hidden" name="admin_action" value="clear_history">
                    <label>Delete readings older than:</label>
                    <select name="days"><option value="7">7 days</option><option value="14">14 days</option><option value="30">30 days</option></select>
